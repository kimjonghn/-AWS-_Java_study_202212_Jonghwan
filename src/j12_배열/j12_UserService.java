...
public class j12_UserService {
	...
	public void run() {
		...
		while(loopFlag) {
			...
			loopFlag = mainMenu(select); //false면 멈춘다 break?
		}
	}
	...
	public void stop() {
		...
		private char inputSelect(String menuName) {
			System.out.println(menuName + "메뉴선택");
	...
	private boolean mainMenu(char select) {
		...
		System.out.println(getSelectedErroMessage());
		}
	}
	System.out.println();
	...
	private String getSelectedErroMessage() {
